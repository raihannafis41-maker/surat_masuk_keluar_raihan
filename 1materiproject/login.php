...
<head>
  ...
  <script defer src="https://kit.fontawesome.com/a2d9b5b8f0.js"></script>
</head>
      ...
      <div class="login-visual">
        ...
        <div class="envelope-wrap" aria-hidden="true">
          <div class="envelope" id="env1">
            <div class="envelope-count">
              <span class="count-to" data-count="27" data-delay="120">0</span>
            </div>
          </div>
          <div>
    ...
    <div class="loader-card">
      <div style="display:flex;align-items:center;gap:12px">
        ...
        <div>
          ...
          <div style="color:var(--muted);font-size:13px">Sedang memeriksa kredensial...</div>
        </div>
      </div>
