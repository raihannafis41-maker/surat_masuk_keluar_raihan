...
if (isset($_POST['simpan'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
            die("<script>alert('Gagal mengupload foto pegawai!'); window.history.back();</script>");
        }
    }
...
<style>
    ...
    .form-control::placeholder {
        color: #94a3b8; /* abu muda, terlihat tapi tidak dominan */
    }
    ...
    <div class="card card-modern mx-auto col-md-8">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="p-4">
            ...
            <div class="text-end mt-4">
                ...
                <a href="index.php?halaman=pegawai" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i> Kembali</a>
            </div>
        </form>
    </div>
</div>
